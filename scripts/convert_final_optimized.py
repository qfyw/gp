...
# 加载数据
with open('datasets/final_optimized/comparison_results_50.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
# 保存为CSV
output_file = Path('datasets/final_optimized/ragquesteval_input_full_hybrid.csv')
